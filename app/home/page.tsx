        ...
        <ScreenContainer>
            ...
            <header className="flex h-16 items-center justify-between px-6 pt-4 pb-2">
                <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xs text-slate-500">cist.b221.h.sato@gmail.com</span>
                </div>
                <Link href="/" className="flex items-center gap-1 text-xs text-slate-500 hover:text-slate-700">
